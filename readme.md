# Life jacket target detection dataset 3100 images with annotations supports VOC and YOL

# Body

Life jacket target detection dataset, 3100 images, with annotations, supports VOC and YOLOF formats
Images are clear, content is complete, suitable for friends who want to do target detection and dataset.
The electronic version will be sent immediately upon purchase, ready at any time, no need to wait for shipping.
